    ...
    <div class="h-[130px] w-[220px] overflow-hidden">
      ...
      >
        ...
        <UseImage
          v-if="covers[1]"
          :src="covers[1]"
          class="relative rounded h-[150px] object-cover aspect-[180/270] z-20 mb-1 select-none bg-dune-800 group-hover:bg-dune-600 animate-fade-in"
          :class="{
        ...
        >
          <template #loading>
            >
            <div
              class="relative rounded h-[150px] object-cover aspect-[180/270] z-20 mb-1 select-none bg-dune-800 animate-pulse"
            />
          </template>
        </UseImage>
        <UseImage
