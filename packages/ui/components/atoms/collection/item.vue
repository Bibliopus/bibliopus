  ...
  <div class="p-3 w-fit bg-dune-900 border border-dune-800 rounded-md cursor-pointer hover:bg-dune-800 hover:border-dune-600 transition-colors">
    <div class="max-h-[130px] overflow-hidden">
      <div class="flex justify-center px-2 items-end">
        <UseImage
          :src="covers[0]"
          class="relative rounded h-[150px] object-cover aspect-[180/270] -rotate-6 z-10"
        />
        <UseImage
          :src="covers[1]"
          class="relative rounded h-[150px] object-cover aspect-[180/270] -mx-10 z-20 mb-1"
        />
        <UseImage
          :src="covers[2]"
          class="relative rounded h-[150px] object-cover aspect-[180/270] rotate-6 z-30"
        />
      </div>
    </div>
